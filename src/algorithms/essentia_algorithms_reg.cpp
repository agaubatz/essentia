...
ESSENTIA_API void registerAlgorithm() {
	...
	//agaubatz added
	AlgorithmFactory::Registrar<FFTK> fftk;
	AlgorithmFactory::Registrar<IFFTK> ifftk;
}}}
...
ESSENTIA_API void registerAlgorithm() {
   ...
   // AlgorithmFactory::Registrar<IFFTWComplex, essentia::standard::IFFTWComplex> regIFFTWComplex;
	...
	//agaubatz added
	AlgorithmFactory::Registrar<FFTK, essentia::standard::FFTK> fftk;
	AlgorithmFactory::Registrar<IFFTK, essentia::standard::IFFTK> ifftk;
}}}
